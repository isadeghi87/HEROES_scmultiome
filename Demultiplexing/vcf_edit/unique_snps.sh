...
declare -A samples
samples=(
    ["I005_014"]="pool3.merged.vcf.gz"
    ["I010_013"]="pool3.merged.vcf.gz"
    ["I020_001"]="pool3.merged.vcf.gz"
    ["I023_037"]="pool3.merged.vcf.gz"
    ["I005_016"]="pool4.merged.vcf.gz"
    ["I010_022"]="pool4.merged.vcf.gz"
    ["I020_004"]="pool4.merged.vcf.gz"
    ["I023_047"]="pool4.merged.vcf.gz"
)
