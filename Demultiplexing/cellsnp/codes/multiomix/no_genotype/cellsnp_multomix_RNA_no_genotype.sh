#!/bin/bash
### cellsnp-lite usage for 10x multiomix without genotype
...
OUT_DIR="/home/i439h/projects/heroes-aya-pools/temp_analysis/scRNA-Seq/Demultiplexing_results/cellsnp/results/multiomix/RNA/no_genotype/${sample}"
...
cellsnp-lite -s $BAM -b $BARCODE -O $OUT_DIR --UMItag UB -p 22 --minMAF 0.1 --minCOUNT 20 --gzip --genotype
