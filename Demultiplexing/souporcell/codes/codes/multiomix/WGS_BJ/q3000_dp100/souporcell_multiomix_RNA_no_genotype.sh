...
OUT_DIR=/results/multiomix/RNA/no_genotype/${sample}
...
mkdir -p /omics/odcf/analysis/OE0290_projects/heroes-aya_pools/temp_analysis/scRNA-Seq/Demultiplexing_results/souporcell/results/multiomix/RNA/no_genotype/${sample}
