#!/bin/bash
## demultiplex single cell multiomics-RNA data without genotype
# load modules
...
OUT_DIR=/results/multiomix/RNA/WGS/q2000_dp100/${sample}
...
GT=/vcf_files/$pool.merged.vcf

mkdir -p /omics/odcf/analysis/OE0290_projects/heroes-aya_pools/temp_analysis/scRNA-Seq/Demultiplexing_results/souporcell/results/multiomix/RNA/WGS/q2000_dp100/${sample}
