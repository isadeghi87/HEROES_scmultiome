...
OUT_DIR=/demuxafy/ATAC/no_genotype/combined/$pool
#DEMUXALOT_OUTDIR=/demuxafy/ATAC/no_genotype/demuxalot/pool3
SOUPORCELL_OUTDIR=/demuxafy/ATAC/no_genotype/souporcell/$pool
VIREO_OUTDIR=/demuxafy/ATAC/no_genotype/vireo/$pool
PROJECT_DIR="/home/i439h/projects/pools/AG_Thongjuea"
DEMUX_DIR="${PROJECT_DIR}/Software/10x_multiomics/demuxafy"
cd "$DEMUX_DIR" 

mkdir -p /omics/odcf/analysis/OE0290_projects/heroes-aya_pools/AG_Thongjuea/Result/10x_multiomics/Demultiplexing_results/demuxafy/ATAC/no_genotype/combined/$pool
