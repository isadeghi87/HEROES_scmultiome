setwd("/home/i439h/projects/heroes-aya-pools/AG_Thongjuea/Result/10x_multiomics/Demultiplexing_results/demuxafy/ATAC")
...
output_file <- paste0("./souporcell/", pool, "/clusters_fina.tsv")
