...
##files
pool='pool4'
OUT_DIR=/demuxafy/ATAC/genotype/combined/$pool
DEMUXALOT_OUTDIR=/demuxafy/ATAC/genotype/demuxalot/$pool
SOUPORCELL_OUTDIR=/demuxafy/ATAC/genotype/souporcell/$pool
VIREO_OUTDIR=/demuxafy/ATAC/genotype/vireo/$pool
PROJECT_DIR="/home/i439h/projects/pools/AG_Thongjuea"
DEMUX_DIR="${PROJECT_DIR}/Software/10x_multiomics/demuxafy"

mkdir -p /omics/odcf/analysis/OE0290_projects/heroes-aya_pools/AG_Thongjuea/Result/10x_multiomics/Demultiplexing_results/demuxafy/ATAC/genotype/combined/$pool
