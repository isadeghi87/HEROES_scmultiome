...
setwd("/omics/odcf/analysis/OE0536_projects/heroes-aya/scRNA-Seq/Demultiplexing_results/downstream_analysis/multi_omix/")
.libPaths("/omics/odcf/analysis/OE0536_projects/heroes-aya/tools/R/4.0/")
...
dir = "/omics/odcf/analysis/OE0536_projects/heroes-aya/scWGS_PTA/test_souporcell/results/"
files = list.files(path = dir, pattern = "clusters.tsv",full.names = T,recursive = T)
files = files[grep("_atac_result",files)][2:5]
...
# save plots
ggsave('./results/figures/souporcell_summary_atac.pdf',plot = gg,
       width = 10,height = 5)
...
ggsave('./results/figures/souporcell_stats_atac.pdf',plot = gg,
       width = 10,height = 5)
