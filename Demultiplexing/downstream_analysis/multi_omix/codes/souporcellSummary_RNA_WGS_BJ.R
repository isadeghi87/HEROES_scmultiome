...
setwd("/home/i439h/projects/heroes-aya-pools/temp_analysis/scRNA-Seq/Demultiplexing_results/downstream_analysis/scRNAseq/")
...
dir = "/home/i439h/projects/heroes-aya-pools/temp_analysis/scRNA-Seq/Demultiplexing_results/souporcell/results/scRNAseq/"
...
# save plots
ggsave('./results/figures/souporcell_summary_RNA_WGS_BJ.pdf',plot = gg,
       width = 10,height = 5)
...
ggsave('./results/figures/souporcell_stats_RNA_WGS_BJ.pdf',plot = gg,
       width = 10,height = 5)
